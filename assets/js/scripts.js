...
signupForm.addEventListener("submit", async (e) => {
  e.preventDefault();
  try {
    // ... logique d’inscription avec Firebase Auth
    document.getElementById("upload-feedback").textContent = "✅ Inscription réussie ! Bienvenue 🎶";
  } catch (error) {
    document.getElementById("upload-feedback").textContent = "❌ Une erreur est survenue : " + error.message;
  }
});